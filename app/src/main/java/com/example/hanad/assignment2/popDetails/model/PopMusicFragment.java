                ...
                iRequestInterface.getPopMusicList()
                        ...
                        .subscribe(new Consumer<PopMusicList>() {
                                       ...
                                       public void accept(PopMusicList popMusicList) throws Exception {
                                           recyclerView.setAdapter(new PopMusicAdapter(PopMusicFragment.this.getActivity().getApplicationContext(), popMusicList.getResults(), PopMusicFragment.this, popMusicList, R.layout.row));
