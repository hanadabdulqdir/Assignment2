package com.example.hanad.assignment2.classicDetails.model;
...
import com.example.hanad.assignment2.popDetails.model.PopMusicAdapter;
                ...
                iRequestInterface.getClassicMusicList()
                        ...
                        .subscribe(new Consumer<ClassicMusicList>() {
                                       ...
                                       public void accept(ClassicMusicList classicMusicList) throws Exception {
                                           recyclerView.setAdapter(new ClassicMusicAdapter(ClassicMusicFragment.this.getActivity().getApplicationContext(), classicMusicList.getResults(), ClassicMusicFragment.this, classicMusicList, R.layout.row));
